...
import com.cg.bookStore.web.OrderController;
...
public class OrderControllerTest {
	...
	@Test
	public void testListOfOrders() throws Exception {
	
		 int id=101;
		 List<OrderInformation> list = new ArrayList<OrderInformation>();
		 list.add(new OrderInformation());
		 list.add(new OrderInformation());
			
	     String inputInJson = this.mapToJson(list);
	     String uri= "/viewOrderByCustomerId/"+id;
	     
		Mockito.when(service.viewOrderByCustomerId(Mockito.anyInt()))	//return mockOrder 
	     .thenReturn(list);
	...
	public void TestClear() throws Exception {
		String uri= "/bookstore/clearcartbycustomerid/101";
	     
	     Mockito.when(service.clearCartByCustomerId(Mockito.anyInt())).thenReturn(null);
	...
	public void TestDeleteBook() throws Exception {
		String uri= "/bookstore/removecartitem/1001";
	     
	     Mockito.when(service.removeCartItem(Mockito.anyInt())).thenReturn(null);
